...
<h4 class="box-title"><a class="btn btn-secondary" href="{{route('actualite.create')}}" ><i class="fa fa-plus-circle"></i> Ajouter Actualité</a></h4>
...
<script>
        ...
        $('.dltBtn').click(function(e){
            ...
            swal({
                title: "Êtes-vous sûr?",
                text: "Une fois supprimé, vous ne pourrez pas récupérer cette actualité !",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                })
                ...
                if (willDelete) {
                    form.submit();
                    swal("Poof! Votre actualité a été supprimée!", {
                    icon: "success",
                    });
                } else {
                    swal("Votre actualité n'est pas supprimée!");
                }
                });
        });
</script>
