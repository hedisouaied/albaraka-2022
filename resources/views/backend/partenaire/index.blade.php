...
<h4 class="box-title"><a class="btn btn-secondary" href="{{route('partenaire.create')}}" ><i class="fa fa-plus-circle"></i> Ajouter partenaire</a></h4>
...
<script>
        ...
        $('.dltBtn').click(function(e){
            ...
            swal({
                title: "Êtes-vous sûr?",
                text: "Une fois supprimé, vous ne pourrez pas récupérer ce partenaire!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                })
                ...
                if (willDelete) {
                    form.submit();
                    swal("Poof! Votre partenaire a été supprimée!", {
                    icon: "success",
                    });
                } else {
                    swal("Votre partenaire non supprimée!");
                }
                });
        });
</script>
